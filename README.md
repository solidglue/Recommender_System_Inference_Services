...
| Type | Component | Description |
| --- | --- | --- |
| Feature | [feature engineering]([https://github.com/solidglue/RecommenderSystems-Inference-Microservices/tree/master/pkg/infer_samples/feature](https://github.com/solidglue/Recommender_System_Inference_Services/tree/master/pkg/infer_features)) | user offline、user realtime、user seq features and item features. |
